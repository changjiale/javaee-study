    ...
    <center>
        ...
        <div id="PromptDiv">
          ...
          <div id="PromptConLeftDiv">
            <i class="PromptCon" style="width: 35px;height: 20px;text-align:center; background-color: yellow;font-size: 13px;" >GOLD</i>
            <i class="PromptCon" style="width: 50px;height: 20px;text-align:center; background-color: #DDD;font-size: 13px;">SILVER</i>
            <i class="PromptCon" style="width: 55px;height: 20px;text-align:center;background-color: #8b4513;font-size: 13px;font-size: 13px;">BRONZE</i>
            ...
            <div id="PromptConRightDiv">
	            <i class="PromptConright" style="width: 140px;height: 20px;text-align:center; background-color: #FF9999;font-size: 13px;">Attempted problem</i>
	            <i class="PromptConright" style="width: 110px;height: 20px;text-align:center; background-color: #33ff33;font-size: 13px;">Solved problem</i>
	            <i class="PromptConright" style="width: 170px;height: 20px;text-align:center; background-color: #aaaaff;font-size: 13px;">First to solve problem</i>
            </div>
        </div>
        <div id="tableDiv">
