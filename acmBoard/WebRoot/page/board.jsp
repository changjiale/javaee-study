...
<head>
    ...
    -->
    <link rel="stylesheet" type="text/css" href="css/bordcss.css">
    ...
    <script type="text/javascript">
        ...
        $(function () {
            //显示榜单数据
            //返回OJ
            $("#retuenOj").click(function () {
                window.location.href = "http://acm.pdsu.edu.cn/";
                return false;
            });
...
<center>
    ...
    <div id="PromptDiv">
        ...
        <div id="PromptConLeftDiv">
            <i class="PromptCon" style="width: 45px;background-color: yellow;">GOLD</i>
            <i class="PromptCon" style="width: 60px;background-color: #DDD;">SILVER</i>
            <i class="PromptCon" style="width: 65px;background-color: #8b4513;">BRONZE</i>
        ...
        <div id="PromptConRightDiv">
            <i class="PromptConright" style="width: 150px;background-color: #FF9999;">Attempted problem</i>
            <i class="PromptConright" style="width: 120px;background-color: #33ff33;">Solved problem</i>
            <i class="PromptConright" style="width: 190px;background-color: #aaaaff;">First to solve problem</i>
        </div>
    </div>
    <div id="tableDiv">
